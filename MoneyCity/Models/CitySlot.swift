...
public struct CitySlot: Identifiable, Hashable, Sendable {
    ...
    public static let allSlots: [CitySlot] = [
        CitySlot(id: "slot_tree_sakura", name: "גן הפריחה", subtitle: "פינת טבע בקצה שמורת הטבע", districtId: "savings", icon: "leaf.fill", defaultItemId: "tree_sakura"),
        ...
        CitySlot(id: "slot_repair_bench", name: "פינת המנוחה", subtitle: "רחבת ישיבה בשמורת הטבע", districtId: "savings", icon: "chair.lounge.fill", defaultItemId: "repair_bench"),
