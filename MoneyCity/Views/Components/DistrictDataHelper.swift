    ...
    public static func districtBuildingPills<T: ExpenseReadable>(
        ...
        case "civic":
            ...
            return [
                ...
                BuildingPillItem(id: "city_sorting_hub", title: isHe ? "ללא קטגוריה" : "Uncategorized", amount: otherAmount, info: DistrictBuildingInfo(id: "city_sorting_hub", districtId: "civic", name: isHe ? "ללא קטגוריה" : "Uncategorized", amount: otherAmount, visitCount: otherCount, trendText: buildingTrendText(for: "city_sorting_hub", transactions: transactions, language: language)))
            ]
        default:
            return []
        }
