    ...
    function makeFigure(opts) {
      ...
      if (appearance) {
        ...
        if (appearance.topStyle !== 'basic' && appearance.topStyle !== 'longTop') {
          addClothingDetail(torso, appearance.topStyle, citizenMat(appearance.topColor, 0.76));
        }
      } else if (opts.bag) {
      ...
      // Arms — track upper-arm meshes for material update on pool reuse.
      const armUpperMeshes = [];
      function arm(side) {
      ...
      fig.userData = {
        ...
        hairGrp: hairGrp, accGrp: accGrp,
        skinMeshes:  [headMesh, noseMesh, neckMesh],
