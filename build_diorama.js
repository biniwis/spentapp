...
<body>
  ...
  <script>
    ...
    // 1. Central Plaza & Fountain stroller (circles around the fountain on the paved promenade, never through the basin or water)
    addCitizen(0x3B82F6, 0x1E293B, 0xEF4444, [
      ...
      {x: -2.4, z: 2.5},
      {x: -2.4, z: 1.4}
    ], ["איזה כיף להסתובב ליד המזרקה ⛲", "העיר הזו נראית מעולה! 🏙️"], ["Lovely stroll around the fountain ⛲", "This city looks amazing! 🏙️"], false, 0.35);
